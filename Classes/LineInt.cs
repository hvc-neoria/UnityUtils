...
namespace HvcNeoria.Unity.Utils
{
    ...
    /// 線分。
    /// </summary>
    public struct LineInt : IRectangleInt
    {
        /// <summary>
        /// 左下隅の位置。
        /// </summary>
        ...
        public LineInt(Vector2Int position, Vector2Int size, Vector2Int parentPosition = default(Vector2Int))
        {
            if (size.x != 1 && size.y != 1)
            {
                throw new ArgumentException("幅も高さも1ではありません。");
            }
