...
namespace HvcNeoria.Unity.Utils
{
    public static class CollectionExtensions
    {
        ...
        /// </summary>
        /// <param name="iList">リスト</param>
        public static void Shuffle(this IList iList)
        {
            for (int i = 0; i < iList.Count - 2; i++)
            {
                var j = Random.Range(i, iList.Count);
        ...
        /// </summary>
        /// <param name="floats">floatのiList</param>
        /// <returns>重複削除したfloatのList</returns>
        public static List<float> Distinct(this IList<float> floats)
        {
